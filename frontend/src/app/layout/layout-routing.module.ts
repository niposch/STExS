  ...
  // },
  {
    ...
    children: [
      ...
      },
      {
        path: 'register',
        loadChildren: () =>
          import('../components/authentication/register/register.module').then(
            (x) => x.RegisterModule
          ),
      },
        ...
        children: [
          {
            ...
            children: [
              ...
              {
                path: 'module/administrate',
                component: AdministrateModuleComponent,
              },
              {
                path: 'module/administrate/chapter',
                component: ChapterAdminAdministrateComponent,
              },
              {
                path: 'codeoutput/create',
                component: CreateEditCodeOutputComponent,
              },
              { path: 'cloze/create', component: CreateEditClozeComponent },
              { path: 'parson/create', component: CreateEditParsonComponent },
              {
                path: 'grading/exercise',
                component: GradingExerciseDashboardComponent,
              },
