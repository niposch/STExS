...
\begin{myreq}
  ...
  {\reqtype F}
  {\reqevent 7.9}
  \reqdesc programming task timer
  \reqrat coding task with restricted time limit should be assigned with its own timer
  \reqorig Lei Ding
  \reqfit show remaining time, resume after reconnect, Precise to the second
  \twoinline
  {\reqsatis 5}
  {\reqdissat 3}
  \twoinline
...
\begin{myreq}
  ...
  {\reqtype F}
  {\reqevent 7.9}
  \reqdesc personal infor management
  \reqrat users should be able to control the information of their own account
  \reqorig Lei Ding
...
\begin{myreq}
  ...
  {\reqtype F}
  {\reqevent 9.9}
  \reqdesc Der Admin kann Studenten zu Kursen hinzufügen.
  \reqrat Der Student erhält Zugang zu Kursen durch den Admin. Er muss nicht selbständig nach einem Kurs suchen und sich möglicherweise in einen falschen Kurs eintragen.
  \reqorig Admin
  \reqfit Der Student wird nur den durch den Admin festgelegten Kursen zugewiesen.
  \twoinline
  {\reqsatis 5}
  {\reqdissat 5}
  \twoinline
...
\begin{myreq}
  ...
  {\reqtype F}
  {\reqevent 9.9}
  \reqdesc Der Admin kann Kurse manuell oder zu einem bestimmten Zeitpunkt sperren.
  \reqrat Die Bearbeitung eines falschen Kurses durch den Studenten wird ausgeschlossen. Ein nicht fertiger Kurs kann erst in seiner finalen Form durch einen Studenten eingesehen werden. Der Admin kann sich zur Bearbeitung des Kurses die Zeit nehmen, die er benötigt und den Kurs im Anschluss wieder entsperren.
  \reqorig Admin
...
\begin{myreq}
  ...
  \reqrat Grundlegende Datensicherheit muss gewährleistet sein.
  \reqorig ST-Praktikum
...
\begin{myreq}
  ...
  \reqrat Bewertungsdaten für bürokratische Zwecke ausserhalb der Andwendung vorhanden sein können.
  \reqorig Admin (Kursleiter)
  \reqfit Test-Export durchführen, mit Stakeholder abgleichen.
  \twoinline
  {\reqsatis 4}
  {\reqdissat 4}
  \twoinline
...
\begin{myreq}
  ...
  {\reqtype NF}
  {\reqevent KW45}
  \reqdesc Ein durchschnittlicher, unerfahrener Nutzer soll in unter 10 Minuten in der Lage sein, eine Frage, auf welchem ihm die Antwort bekannt ist, richtig zu beantworten
  ...
  \reqfit Testdurchlauf von Aufgaben durch einen externen Tester (zB einen Nutzer der "Admin" Gruppe)
  \twoinline
  {\reqsatis 3}
  {\reqdissat 3}
  \twoinline
...
\begin{myreq}
  ...
  {\reqtype F}
  {\reqevent }
  \reqdesc Eine neue Aufgabe von den bestehenden Aufgabentypen erstellen.
  \reqrat Kursverantwortliche/Admins können Aufgaben spezifisch zum Kursthema erstellen und durch eine Vielfalt von Aufgaben kann der Benutzer das Thema noch mehr vertiefen.
  \reqorig Admin
  \reqfit Aufgaben sind nach dem Anlegen in der Datenbank vorhanden.
  \twoinline
  {\reqsatis 4}
  {\reqdissat 5}
  \twoinline
...
\begin{myreq}
  ...
  {\reqtype NF}
  {\reqevent }
  \reqdesc Die Auswahl mehrerer Aufgaben für einen Kurs soll über eine Tabellenansicht möglich sein.
  \reqrat Die Tabellenansicht ist übersichtlich und der Kursverantwortliche kann schnell für ihn passende Aufgaben auswählen und zum Kurs hinzufügen.
  \reqorig Admin
  \reqfit Tabelle bei Aufgabenzuweisung zu sehen
  \twoinline
  {\reqsatis 4}
  {\reqdissat 2}
  \twoinline
